  ...
  return (
    <form onSubmit={handleSubmit} className="flex gap-2">
      <input
        ...
        disabled={disabled}
        autoComplete="off"
        className="flex-1 px-3 py-2 border border-gray-600 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-yellow-500 disabled:opacity-50 disabled:cursor-not-allowed text-gray-100 bg-gray-700 placeholder-gray-400"
      />
      <button
        type="submit"
